...
$script:AppVersion = [version]"1.0.0.0"
...
$script:I18N = @{
    en = @{
        ...
        HelpText=(
            "Source and Target",
            "Choose source and target (local or UNC).",
            "Examples:",
            ...
            "Options:",
            "  - MOVE   = moves files (source emptied)",
            "  - MIRROR = target matches source (deletes extras in target)",
            "",
            "Compare",
    ...
    de = @{
        ...
        HelpText=(
            "Quelle und Ziel",
            "Quelle und Ziel waehlen (lokal oder UNC). Beispiele:",
            ...
            "Optionen:",
            "  - MOVE   = verschiebt Dateien (Quelle wird geleert)",
            "  - MIRROR = Ziel entspricht Quelle (loescht Extras im Ziel)",
            "",
            "Vergleich",
        ...
        FooterLangHint="Language/Sprache: start tool with -Lang de | -Lang en"
    }
}
...
[void]$syncLayout.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 110)))
...
$optCard.Controls.AddRange(@($optTitle,$optDesc,$chkMove,$chkMirror,$lblMirrorWarn))
...
$helpCard.Dock = 'Fill'
$helpCard.Padding = New-Object System.Windows.Forms.Padding(16)
$helpCard.BackColor = [System.Drawing.Color]::FromArgb(232, 242, 255)
...
$helpTitle.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$helpTitle.ForeColor = [System.Drawing.Color]::FromArgb(25, 58, 92)

$helpSub = New-Object System.Windows.Forms.Label
$helpSub.Text = (T "HelpSub")
$helpSub.AutoSize = $true
$helpSub.ForeColor = [System.Drawing.Color]::FromArgb(60, 90, 120)
$helpSub.Location = New-Object System.Drawing.Point(2, 30)

$helpTextWrap = New-Object System.Windows.Forms.Panel
$helpTextWrap.Location = New-Object System.Drawing.Point(12, 62)
$helpTextWrap.Anchor   = 'Top,Left,Right,Bottom'
$helpTextWrap.Padding  = New-Object System.Windows.Forms.Padding(12, 10, 12, 10)
$helpTextWrap.BackColor = [System.Drawing.Color]::FromArgb(245, 250, 255)
$helpTextWrap.BorderStyle = 'FixedSingle'

$helpText = New-Object System.Windows.Forms.RichTextBox
$helpText.ReadOnly    = $true
$helpText.BorderStyle = 'None'
$helpText.BackColor   = $helpTextWrap.BackColor
$helpText.ForeColor   = [System.Drawing.Color]::FromArgb(35, 55, 80)
$helpText.Font        = New-Object System.Drawing.Font("Segoe UI", 10)
$helpText.WordWrap    = $true
$helpText.ScrollBars  = 'Vertical'
$helpText.DetectUrls  = $false
$helpText.Dock        = 'Fill'
$helpText.Text = (T "HelpText") + "`r`n`r`n" + (T "HelpUncCompareLim") + "`r`n`r`n" + (T "UncBestPractice")

$helpTextWrap.Controls.Add($helpText)
$helpCard.Controls.Add($helpTitle)
$helpCard.Controls.Add($helpSub)
$helpCard.Controls.Add($helpTextWrap)

$helpCard.Add_Resize({
    if ($helpTextWrap -and -not $helpTextWrap.IsDisposed) {
        $helpTextWrap.Size = New-Object System.Drawing.Size(($helpCard.ClientSize.Width - 24), ($helpCard.ClientSize.Height - 78))
    }
})
$helpTextWrap.Size = New-Object System.Drawing.Size(($helpCard.ClientSize.Width - 24), ($helpCard.ClientSize.Height - 78))
